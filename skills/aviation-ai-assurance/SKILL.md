...
carries an `edge_case` data story, quote it beside the screen: a registration
...
Cite the data story with its source and window; it is one receiver or one feed on
